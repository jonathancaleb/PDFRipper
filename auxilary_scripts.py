...
def pdf2image(file, folder, output_file):
	start_time = time.time()

	pil_images = pdf2image.pdf2image.convert_from_path(file, dpi = DPI, output_folder = folder, output_file = output_file,first_page = FIRST_PAGE,
